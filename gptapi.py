# -*- coding: utf-8 -*-
"""
Created on Sat Jan 25 19:36:11 2025
...
def get_response(content):
    ...
    if response != "None":
        ...
        #parse into key-value pairs into a dictionary
        parsed_dict = {kv.split(": ")[0]: kv.split(": ")[1] for kv in key_value_pairs}
